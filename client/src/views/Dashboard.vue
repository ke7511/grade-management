...
onMounted(async () => {
  if (role.value !== 'student') {
    try {
      ...
      await gradeStore.loadStudents()

      stats.value = {
        courses: gradeStore.courses?.length || 0,
        students: gradeStore.students?.length || 0,
        classes: gradeStore.classes?.length || 0,
        failedCount: 0
      }
    } catch {
      // 加载失败时使用默认值
...
<template>
  <div class="dashboard">
    ...
    <div class="page-card">
      ...
      <el-timeline>
        <el-timeline-item timestamp="2026-01-15" placement="top">
          <el-card shadow="never">
            <h4>2025-2026学年第一学期期末成绩已开放查询</h4>
        ...
        <el-timeline-item timestamp="2026-01-05" placement="top">
          <el-card shadow="never">
            <h4>系统升级完成</h4>
